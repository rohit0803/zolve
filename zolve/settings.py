"""
Django settings for zolve project.
...
WSGI_APPLICATION = 'zolve.wsgi.application'
...
#     'wallet.authentication.EmailAuthBackend',  # to be able to login with email, described next
# ]
